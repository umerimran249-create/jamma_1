        ...
        <div className="founder-side-top">
          ...
          <div className="founder-side-intro">
            ...
            <p>
              ...
              Director, and a Fellow of both the Energy Institute and the Institute of Directors. Dr. Poku has an undergraduate degree in Engineering, a PhD in healthcare and is an alumnus of INSEAD through the International Directors Programme.
            </p>
          </div>
        </div>
      </div>
